...
//      carrier.setData(new FeatureVectorSequence(fvs));
  ...
  private static final CommandOption.String testOption = new CommandOption.String(HMMSimpleTagger.class, "test", "lab or seg=start-1.continue-1,...,start-n.continue-n",true, null, "Test measuring labeling or segmentation (start-i, continue-i) accuracy", null);

  private static final CommandOption.File modelOption = new CommandOption.File(HMMSimpleTagger.class, "model-file", "FILENAME", true, null, "The filename for reading (train/run) or saving (train) the model.", null);
